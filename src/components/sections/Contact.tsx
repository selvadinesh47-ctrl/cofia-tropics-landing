    ...
    <section id="contact" className="py-20 bg-gradient-to-br from-orange-50 to-amber-50">
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-16">
          <h2 className="text-5xl font-bold text-orange-900 mb-6">Get In Touch</h2>
            ...
            <div className="space-y-6">
              <Card className="border-0 shadow-lg bg-white/80 backdrop-blur-sm hover:shadow-xl transition-shadow duration-300">
                <CardContent className="p-6 flex items-center space-x-4">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold text-orange-800 mb-1">Phone</h3>
                    <p className="text-orange-600">+91 99948 98713</p>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card className="border-0 shadow-lg bg-white/80 backdrop-blur-sm hover:shadow-xl transition-shadow duration-300">
                <CardContent className="p-6 flex items-center space-x-4">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold text-orange-800 mb-1">Email</h3>
                    <p className="text-orange-600">info@cofia.com</p>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card className="border-0 shadow-lg bg-white/80 backdrop-blur-sm hover:shadow-xl transition-shadow duration-300">
                <CardContent className="p-6 flex items-center space-x-4">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold text-orange-800 mb-1">Address</h3>
                    <p className="text-orange-600">Coconut Farms, Kerala, India</p>
                  </div>
                </CardContent>
              </Card>
            </div>
          ...
          <Card className="border-0 shadow-xl bg-white">
            ...
            <CardContent className="p-8">
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                {/* Inquiry Type */}
                <div>
                  <label htmlFor="inquiry" className="block text-sm font-medium text-orange-700 mb-2">
                    Inquiry Type
                  </label>
                  <select
                    id="inquiry"
